...
namespace BookStore.API.Migrations
{
    ...
    [Migration("20221231122945_add-saleStatus-and-Date-in-Sales-table")]
    partial class addsaleStatusandDateinSalestable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "11521276-771a-4730-9fc1-0fcaa31f8d13",
                            ConcurrencyStamp = "3dc93667-09ca-4478-adc0-d7597722b208",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "c1632c5d-f945-4b1b-b975-1a4c19bfcd38",
                            ConcurrencyStamp = "352a6001-16a3-41ec-a4cc-e369749a6814",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("BookStore.API.Models.Book", b =>
                {
                    b.HasOne("BookStore.API.Models.Author", "AuthorFk")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookStore.API.Models.Category", "CategoryFk")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookStore.API.Models.Publisher", "PublisherFk")
                        .WithMany()
                        .HasForeignKey("PublisherId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookStore.API.Models.Translator", "TranslatorFk")
                        .WithMany()
                        .HasForeignKey("TranslatorId");

                    b.Navigation("AuthorFk");

                    b.Navigation("CategoryFk");

                    b.Navigation("PublisherFk");

                    b.Navigation("TranslatorFk");
                });
